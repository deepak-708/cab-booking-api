...
> 💡 **Production Note:** The development branch (`main`) is configured for a local MySQL environment. To deploy on cloud architecture, the project was migrated to PostgreSQL. The fully live, production-ready code can be found on the `feature/postgres-migration` branch.
